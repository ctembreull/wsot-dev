...
abstract class BaseUser extends BaseObject  implements Persistent
{
	...
	/**
	 * Get the [terms_accepted] column value.
	 * 
	 * @return     boolean
	 */
	...
	public function setVerified($v)
	{
		...
		if ($this->verified !== $v) {
			$this->verified = $v;
			$this->modifiedColumns[] = UserPeer::VERIFIED;
		}
	...
	/**
	 * Set the value of [terms_accepted] column.
	 * 
	 * @param      boolean $v new value
	 * @return     User The current object (for fluent API support)
	 */
	public function setTermsAccepted($v)
	{
		...
		if ($this->terms_accepted !== $v) {
			$this->terms_accepted = $v;
			$this->modifiedColumns[] = UserPeer::TERMS_ACCEPTED;
		}
	...
	public function setModifiedAt($v)
	{
		...
		if ( $this->modified_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UserPeer::MODIFIED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->verified = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->active = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->terms_accepted = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->created_at = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->modified_at = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setTermsAccepted($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::VERIFIED)) $criteria->add(UserPeer::VERIFIED, $this->verified);
		if ($this->isColumnModified(UserPeer::ACTIVE)) $criteria->add(UserPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(UserPeer::TERMS_ACCEPTED)) $criteria->add(UserPeer::TERMS_ACCEPTED, $this->terms_accepted);
		if ($this->isColumnModified(UserPeer::CREATED_AT)) $criteria->add(UserPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(UserPeer::MODIFIED_AT)) $criteria->add(UserPeer::MODIFIED_AT, $this->modified_at);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTermsAccepted($this->terms_accepted);
	 ...
	 * @return     PropelCollection|array Invitation[] List of Invitation objects
	 * @throws     PropelException
	 */
	public function getInvitations($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collInvitations || null !== $criteria) {
	...
	public function addInvitation(Invitation $l)
	{
		...
		if (!$this->collInvitations->contains($l)) { // only add it if the **same** object is not already associated
			$this->collInvitations[]= $l;
			$l->setUser($this);
		}
	}
	...
	/**
	 * Clears out the collPreferences collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collPreferences collection.
	 *
	...
	{
		$this->collPreferences = new PropelObjectCollection();
		$this->collPreferences->setModel('Preference');
	}
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array Preference[] List of Preference objects
	 * @throws     PropelException
	 */
	public function getPreferences($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collPreferences || null !== $criteria) {
			if ($this->isNew() && null === $this->collPreferences) {
				// return empty collection
				$this->initPreferences();
			} else {
				$collPreferences = PreferenceQuery::create(null, $criteria)
					->filterByUser($this)
					->find($con);
				if (null !== $criteria) {
					return $collPreferences;
				}
				$this->collPreferences = $collPreferences;
			}
		}
	...
	public function countPreferences(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collPreferences || null !== $criteria) {
			if ($this->isNew() && null === $this->collPreferences) {
				...
				$query = PreferenceQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
			...
			return count($this->collPreferences);
		}
	}
	...
	public function addPreference(Preference $l)
	{
		...
		if (!$this->collPreferences->contains($l)) { // only add it if the **same** object is not already associated
			$this->collPreferences[]= $l;
			$l->setUser($this);
		}
	}
