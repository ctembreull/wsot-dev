...
abstract class BaseInvitation extends BaseObject  implements Persistent
{
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = InvitationPeer::EMAIL;
		}
	...
	public function setFirstName($v)
	{
		...
		if ($this->first_name !== $v) {
			$this->first_name = $v;
			$this->modifiedColumns[] = InvitationPeer::FIRST_NAME;
		}
	...
	public function setLastName($v)
	{
		...
		if ($this->last_name !== $v) {
			$this->last_name = $v;
			$this->modifiedColumns[] = InvitationPeer::LAST_NAME;
		}
	...
	public function setHash($v)
	{
		...
		if ($this->hash !== $v) {
			$this->hash = $v;
			$this->modifiedColumns[] = InvitationPeer::HASH;
		}
	...
	public function setRedeemed($v)
	{
		...
		if ($this->redeemed !== $v) {
			$this->redeemed = $v;
			$this->modifiedColumns[] = InvitationPeer::REDEEMED;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = InvitationPeer::CREATED_AT;
			}
	...
	public function setModifiedAt($v)
	{
		...
		if ( $this->modified_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = InvitationPeer::MODIFIED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->redeemed = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->created_at = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->modified_at = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->resetModified();
			...
			return $startcol + 9; // 9 = InvitationPeer::NUM_COLUMNS - InvitationPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(InvitationPeer::ID) ) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setRedeemed($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(InvitationPeer::EMAIL)) $criteria->add(InvitationPeer::EMAIL, $this->email);
		if ($this->isColumnModified(InvitationPeer::FIRST_NAME)) $criteria->add(InvitationPeer::FIRST_NAME, $this->first_name);
		if ($this->isColumnModified(InvitationPeer::LAST_NAME)) $criteria->add(InvitationPeer::LAST_NAME, $this->last_name);
		if ($this->isColumnModified(InvitationPeer::HASH)) $criteria->add(InvitationPeer::HASH, $this->hash);
		if ($this->isColumnModified(InvitationPeer::REDEEMED)) $criteria->add(InvitationPeer::REDEEMED, $this->redeemed);
		if ($this->isColumnModified(InvitationPeer::CREATED_AT)) $criteria->add(InvitationPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(InvitationPeer::MODIFIED_AT)) $criteria->add(InvitationPeer::MODIFIED_AT, $this->modified_at);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setRedeemed($this->redeemed);
