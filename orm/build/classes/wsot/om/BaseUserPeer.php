...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Password', 'Verified', 'Active', 'TermsAccepted', 'CreatedAt', 'ModifiedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'password', 'verified', 'active', 'termsAccepted', 'createdAt', 'modifiedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EMAIL, self::PASSWORD, self::VERIFIED, self::ACTIVE, self::TERMS_ACCEPTED, self::CREATED_AT, self::MODIFIED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'EMAIL', 'PASSWORD', 'VERIFIED', 'ACTIVE', 'TERMS_ACCEPTED', 'CREATED_AT', 'MODIFIED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'password', 'verified', 'active', 'terms_accepted', 'created_at', 'modified_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Password' => 2, 'Verified' => 3, 'Active' => 4, 'TermsAccepted' => 5, 'CreatedAt' => 6, 'ModifiedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'password' => 2, 'verified' => 3, 'active' => 4, 'termsAccepted' => 5, 'createdAt' => 6, 'modifiedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EMAIL => 1, self::PASSWORD => 2, self::VERIFIED => 3, self::ACTIVE => 4, self::TERMS_ACCEPTED => 5, self::CREATED_AT => 6, self::MODIFIED_AT => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'EMAIL' => 1, 'PASSWORD' => 2, 'VERIFIED' => 3, 'ACTIVE' => 4, 'TERMS_ACCEPTED' => 5, 'CREATED_AT' => 6, 'MODIFIED_AT' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'password' => 2, 'verified' => 3, 'active' => 4, 'terms_accepted' => 5, 'created_at' => 6, 'modified_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UserPeer::VERIFIED);
			$criteria->addSelectColumn(UserPeer::ACTIVE);
			$criteria->addSelectColumn(UserPeer::TERMS_ACCEPTED);
			$criteria->addSelectColumn(UserPeer::CREATED_AT);
			$criteria->addSelectColumn(UserPeer::MODIFIED_AT);
		} else {
