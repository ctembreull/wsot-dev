...
/**
 * Base class that represents a row from the 'districts' table.
 *
 * 
 *
...
abstract class BaseDistrict extends BaseObject  implements Persistent
{
	...
	public function setAddress1($v)
	{
		...
		if ($this->address1 !== $v) {
			$this->address1 = $v;
			$this->modifiedColumns[] = DistrictPeer::ADDRESS1;
		}
	...
	public function setAddress2($v)
	{
		...
		if ($this->address2 !== $v) {
			$this->address2 = $v;
			$this->modifiedColumns[] = DistrictPeer::ADDRESS2;
		}
	...
	public function setCity($v)
	{
		...
		if ($this->city !== $v) {
			$this->city = $v;
			$this->modifiedColumns[] = DistrictPeer::CITY;
		}
	...
	public function setState($v)
	{
		...
		if ($this->state !== $v) {
			$this->state = $v;
			$this->modifiedColumns[] = DistrictPeer::STATE;
		}
	...
	public function setCountry($v)
	{
		...
		if ($this->country !== $v) {
			$this->country = $v;
			$this->modifiedColumns[] = DistrictPeer::COUNTRY;
		}
	...
	public function setPostcode($v)
	{
		...
		if ($this->postcode !== $v) {
			$this->postcode = $v;
			$this->modifiedColumns[] = DistrictPeer::POSTCODE;
		}
	...
	public function setPhone($v)
	{
		...
		if ($this->phone !== $v) {
			$this->phone = $v;
			$this->modifiedColumns[] = DistrictPeer::PHONE;
		}
	...
	public function setFax($v)
	{
		...
		if ($this->fax !== $v) {
			$this->fax = $v;
			$this->modifiedColumns[] = DistrictPeer::FAX;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = DistrictPeer::EMAIL;
		}
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = DistrictPeer::URL;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DistrictPeer::CREATED_AT;
			}
	...
	public function setModifiedAt($v)
	{
		...
		if ( $this->modified_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DistrictPeer::MODIFIED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->modified_at = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->resetModified();
			...
			return $startcol + 14; // 14 = DistrictPeer::NUM_COLUMNS - DistrictPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(DistrictPeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DistrictPeer::ADDRESS1)) $criteria->add(DistrictPeer::ADDRESS1, $this->address1);
		if ($this->isColumnModified(DistrictPeer::ADDRESS2)) $criteria->add(DistrictPeer::ADDRESS2, $this->address2);
		if ($this->isColumnModified(DistrictPeer::CITY)) $criteria->add(DistrictPeer::CITY, $this->city);
		if ($this->isColumnModified(DistrictPeer::STATE)) $criteria->add(DistrictPeer::STATE, $this->state);
		if ($this->isColumnModified(DistrictPeer::COUNTRY)) $criteria->add(DistrictPeer::COUNTRY, $this->country);
		if ($this->isColumnModified(DistrictPeer::POSTCODE)) $criteria->add(DistrictPeer::POSTCODE, $this->postcode);
		if ($this->isColumnModified(DistrictPeer::PHONE)) $criteria->add(DistrictPeer::PHONE, $this->phone);
		if ($this->isColumnModified(DistrictPeer::FAX)) $criteria->add(DistrictPeer::FAX, $this->fax);
		if ($this->isColumnModified(DistrictPeer::EMAIL)) $criteria->add(DistrictPeer::EMAIL, $this->email);
		if ($this->isColumnModified(DistrictPeer::URL)) $criteria->add(DistrictPeer::URL, $this->url);
		if ($this->isColumnModified(DistrictPeer::CREATED_AT)) $criteria->add(DistrictPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(DistrictPeer::MODIFIED_AT)) $criteria->add(DistrictPeer::MODIFIED_AT, $this->modified_at);
	 ...
	 * @return     PropelCollection|array School[] List of School objects
	 * @throws     PropelException
	 */
	public function getSchools($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSchools || null !== $criteria) {
